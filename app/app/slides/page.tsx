      ...
      <div className="slides">
        ...
        <section data-background-gradient="linear-gradient(135deg, hsl(200, 85%, 50%) 0%, hsl(200, 85%, 70%) 100%)">
          <div style={{textAlign: 'center', maxWidth: '1000px', margin: '0 auto'}}>
            <h2 style={{fontSize: '4rem', fontWeight: 'bold', color: 'white', textShadow: '2px 2px 4px rgba(0,0,0,0.8)', marginBottom: '2rem'}}>Demo Part 1</h2>
            ...
            <div style={{
              ...
              <iframe 
                src="https://www.loom.com/embed/37a3f4ec1272497abd7cd31acf4c22f0?speed=1&t=0&autoplay=0"
                frameBorder="0" 
                allowFullScreen
                style={{
                  width: '100%', 
        ...
        {/* Demo Part 2 with Same Video */}
        <section data-background-gradient="linear-gradient(135deg, hsl(200, 85%, 50%) 0%, hsl(200, 85%, 70%) 100%)">
          <div style={{textAlign: 'center', maxWidth: '1000px', margin: '0 auto'}}>
            <h2 style={{fontSize: '4rem', fontWeight: 'bold', color: 'white', textShadow: '2px 2px 4px rgba(0,0,0,0.8)', marginBottom: '2rem'}}>Demo Part 2</h2>
            ...
            <div style={{
              ...
              <iframe 
                src="https://www.loom.com/embed/374f04c3b4cf4cffacf97ca2a13a5736?speed=1&t=0&autoplay=0"
                frameBorder="0" 
                allowFullScreen
                style={{
                  width: '100%', 
        ...
        <section data-background-gradient="linear-gradient(135deg, hsl(200, 85%, 50%) 0%, hsl(200, 85%, 70%) 100%)">
          <div style={{textAlign: 'center', maxWidth: '1000px', margin: '0 auto'}}>
            <h2 style={{fontSize: '4rem', fontWeight: 'bold', color: 'white', textShadow: '2px 2px 4px rgba(0,0,0,0.8)', marginBottom: '2rem'}}>Demo Part 3</h2>
            ...
            <div style={{
              ...
              <iframe 
                src="https://www.loom.com/embed/3e64caa0150f4375807a69b1c9fc527d?speed=1&t=0&autoplay=0"
                frameBorder="0" 
                allowFullScreen
                style={{
                  width: '100%', 
